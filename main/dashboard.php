<?php 
    ...
    $isAdmin = ($_SESSION['email'] === 'admin@yahoo.com');
?>
<?php
...
<head>
    ...
    <title>Dashboard For Log-in User</title>
    <div class="toptitle">
        <img id="logo" src="images/logo.png" alt="top">
        <div class="welcome">
            <h1>Welcome to Foody Ref- <?php echo ucfirst($_SESSION['first_name']); ?>,</h1>
        </div>
        <div class="topnav">
            <nav>
                <a href="dashboard.php">Home</a>  .  <a href="recipe2.php">View Recipes</a>  .  <a href="../admin/sort.php">Sort</a>  .
                <a href="post_recipe.php">Add A Recipe</a> .  <a href="../admin/restaurant2.php">Restaurant List</a> .  <a href="../admin/grocery2.php">Grocery List</a> . <a href="../admin/events2.php">Food Events</a>
                <?php if ($isAdmin) { ?>
                    <a href="../admin/create_categories.php">Create Categories</a> .  
                    <a href="../admin/moderate_comments.php">Comment Moderator</a>  .
                    <a href="../admin/users_moderator.php">Users Moderator</a>
                <?php } ?>
                <a href="../admin/logout.php?logout=true">Logout</a> 
            </nav>
        </div>
    </div>
</head>
...
<div class="bottomnav">     
            <nav>
                    <a href="dashboard.php">Home</a>  .   <a href="../admin/career2.php">Career</a> . <a href="../admin/contacts2.php">Contact Us</a>
            </nav>        
        </div>
